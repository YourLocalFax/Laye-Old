   ...
   public void accept(final LayeFunctionBuilder builder, final boolean isResultRequired)
   {
      ...
      switch (Laye.GET_OP(lastOp))
      {
         case Laye.OP_LOAD:
         {
            ...
            {
               throw new CompilerException("local " + builder.getLocalName(local) + " was defined constant, cannot modify.");
            }
            // undo load
            builder.popOp();
         ...
         case Laye.OP_GET_UP:
         {
            ...
            {
               throw new CompilerException("local " + builder.getUpValueName(up) + " was defined constant, cannot modify.");
            }
            // undo get_up
            builder.popOp();
            builder.decreaseStackSize();
