...
{
   /**
    * A Java function that can be called from a Laye script. The first argument,
    * 'root', is the root table of the calling function, and the following
    * 'args' array contains the arguments passed from Laye.
    */
   @FunctionalInterface
